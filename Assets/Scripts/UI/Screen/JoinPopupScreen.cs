...
namespace KitchenKrapper
{
    public class JoinPopupScreen : BaseScreen
    {
        ...
        public override void Show()
        {
            ...
            // add active style
            joinPanelPopup.RemoveFromClassList(MainMenuUIManager.PopupPanelInactiveClassName);
            joinPanelPopup.AddToClassList(MainMenuUIManager.PopupPanelActiveClassName);
        }
